...
namespace EpsonProjectorEpi
{
    public class JoinMap : JoinMapBaseAdvanced
    {
        ...
        [JoinName("VShiftPlus")]
        public JoinDataComplete VShiftPlus = new JoinDataComplete(
        ...
        public JoinDataComplete VShiftMinus = new JoinDataComplete(
        ...
        [JoinName("HShiftPlus")]
        public JoinDataComplete HShiftPlus = new JoinDataComplete(
        ...
        public JoinDataComplete HShiftMinus = new JoinDataComplete(
        ...
        [JoinName("FocusPlus")]
        public JoinDataComplete FocusPlus = new JoinDataComplete(
        ...
        [JoinName("FocusMinus")]
        public JoinDataComplete FocusMinus = new JoinDataComplete(
        ...
        [JoinName("ZoomPlus")]
        public JoinDataComplete ZoomPlus = new JoinDataComplete(
        ...
        [JoinName("ZoomMinus")]
        public JoinDataComplete ZoomMinus = new JoinDataComplete(
        ...
        private void SetIpChangeJoin(uint joinStart)
        {
            ...
            {
                JoinNumber = joinStart + 48, // e.g., join 49
                JoinSpan = 1
            };
